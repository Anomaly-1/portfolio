    ...
    <div className="-mb-80 lg:-mt-24 relative z-20 py-10 lg:py-40 max-w-7xl mx-auto">
      ...
      <div className="flex justify-center items-center h-[40rem] flex-col px-4">
        <div className="text-neutral-500 dark:text-neutral-400 text-xl md:text-3xl max-w-3xl mx-auto text-center">
            Among these languages, there are some specific frameworks that I prefer to work with. Some of which include,{" "}
            ...
            ,{" "}
            <LinkPreview url="https://vuejs.org" className="font-bold">
            Vue.js
            </LinkPreview>
            ,{" "}
            ...
            ,{" "}
            <LinkPreview url="https://flask.palletsprojects.com" className="font-bold">
            Flask
            </LinkPreview>
            ,{" "}
            ...
            ,{" "}
            <LinkPreview url="https://daisyui.com" className="font-bold">
            DaisyUI
            </LinkPreview>
            , and{" "}
            <LinkPreview url="https://www.tensorflow.org" className="font-bold">
            TensorFlow
            </LinkPreview>
            . I am always working toward mastering different frameworks and 
            libraries in order to arrive at custom convienient solutions.
        </div>
        </div>
    </div>
  );
